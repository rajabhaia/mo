...
from RAJAmusic67.utils.database import get_assistant
from config import API_ID, API_HASH
from RAJAmusic67 import app
from config import OWNER_ID
from RAJAmusic67.misc import SUDOERS
from RAJAmusic67.utils.database import get_assistant, clonebotdb
from RAJAmusic67.utils.database.clonedb import has_user_cloned_any_bot
from config import LOGGER_ID, CLONE_LOGGER
import requests
from RAJAmusic67.utils.decorators.language import language
import pyrogram.errors

from RAJAmusic67.utils.database.clonedb import get_owner_id_from_db
from config import SUPPORT_CHAT, OWNER_ID

from datetime import datetime
CLONES = set()

C_BOT_DESC = "Wᴀɴᴛ ᴀ ʙᴏᴛ ʟɪᴋᴇ ᴛʜɪs? Cʟᴏɴᴇ ɪᴛ ɴᴏᴡ! ✅\n\nVɪsɪᴛ: @BeatsMagicBot ᴛᴏ ɢᴇᴛ sᴛᴀʀᴛᴇᴅ!\n\n - Uᴘᴅᴀᴛᴇ: @RAJAmusic67\n - Sᴜᴘᴘᴏʀᴛ: @chodusing"
    ...
    if len(message.command) > 1:
        ...
        try:
            ai = Client(
                ...
                API_HASH,
                bot_token=bot_token,
                plugins=dict(root="RAJAmusic67.cplugin"), 
            )
            await ai.start()
            bot = await ai.get_me()
        ...
        try:
            ...
            await mi.edit_text(
                f"⚠️ <b>ᴇʀʀᴏʀ:</b>\n\n<code>{e}</code>\n\n**ᴋɪɴᴅʟʏ ғᴏᴡᴀʀᴅ ᴛʜɪs ᴍᴇssᴀɢᴇ ᴛᴏ @RAJARAJ909 ᴛᴏ ɢᴇᴛ ᴀssɪsᴛᴀɴᴄᴇ**"
            )
    else:
