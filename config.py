...
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","RAJARAJ909")
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME" , "BeatsMagicBot")
# --------------------------------------------------------
BOT_NAME = getenv("BOT_NAME" , "🎼 𝑩𝒆𝒂𝒕𝒔 𝑴𝒂𝒈𝒊𝒄 𝑩𝒐𝒕")
# ---------------------------------------------------------
ASSUSERNAME = getenv("ASSUSERNAME" , "MusicSenseiBot")

MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME" , "🎼 𝑩𝒆𝒂𝒕𝒔 𝑴𝒂𝒈𝒊𝒄 𝑩𝒐𝒕")
# ---------------------------------------------------------
...
# Define SUDOERS here by reading from an environment variable
SUDOERS = list(
    map(
        int,
        getenv("SUDO_USERS", "").split(),
    )
)
...
CHAT = getenv("CHAT", "https://t.me/chodusing")
# ------------------------------------------------------------------------------
# -------------------------------------------------------------------------------
